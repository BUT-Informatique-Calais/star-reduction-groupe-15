...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollPictures = QScrollArea(Dialog)
        self.scrollPictures.setObjectName(u"scrollPictures")
        self.scrollPictures.setGeometry(QRect(10, 10, 1181, 621))
        self.scrollPictures.setWidgetResizable(True)
        self.scroll_pictures = QWidget()
        self.scroll_pictures.setObjectName(u"scroll_pictures")
        self.scroll_pictures.setGeometry(QRect(0, 0, 1179, 619))
        self.scrollPictures.setWidget(self.scroll_pictures)
