...
# Si on l'aplique à toute l'image, le problème est que les couleurs 
# sont dégradées, le sujet principal que l'on veut isoler s'assombrit également
# Pour régler cela il faut réaliser des masques de l'objet et du fond séparément pour ne pas
# dégrader la qualité de l'image de départ